...
function DebitDetails() {
    ...
    async function handleFetchData(token, id) {
        ...
        await axios.get(`/api/SupplierPortalApi/getsupplierdebitnotedetails?CompanyId=${id}&FromDate=${fDate}&ToDate=${tDate}`, {
            headers: {
    ...
    async function handleDownloadData(token, id, grn) {
        const trn = id + grn.replace("-", "");
        // console.log(trn);

        await axios.get(`/api/SupplierPortalApi/GetDnPdf?CompanyId=${id}&TrnNo=${trn}`, {
            headers: {
                Authorization: `Bearer ${token}`
            },
            ...
            <div>
                <main className="main-content">
                    <div className="card-container">
                        <div className="card">
                            <div className="card-header blue">Supplier Debit Note</div>
